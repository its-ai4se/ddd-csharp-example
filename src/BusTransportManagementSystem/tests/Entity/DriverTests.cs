...
{
    [Fact]
    public void Constructor_WithValidParameters_ShouldCreateDriverAggregate()
    {
        // Arrange
        var id = Guid.NewGuid();
        ...
        // Act
        var driver = new DriverAggregate(id, name, status);
    ...
    public void Constructor_WithoutStatus_ShouldDefaultToActive()
    {
        ...
        // Act
        var driver = new DriverAggregate(id, name);
    ...
    public void Constructor_WithEmptyId_ShouldThrowArgumentException()
    {
        ...
        // Act & Assert
        Assert.Throws<ArgumentException>(() => new DriverAggregate(emptyId, name));
    }
    ...
    public void Constructor_WithNullName_ShouldThrowArgumentNullException()
    {
        ...
        // Act & Assert
        Assert.Throws<ArgumentNullException>(() => new DriverAggregate(id, nullName));
    }
    ...
    {
        // Arrange
        var driver = new DriverAggregate(new DriverName("John Doe"));
    ...
    {
        // Arrange
        var driver = new DriverAggregate(new DriverName("John Doe"), SickLeaveStatus.OnSickLeave);
    ...
    {
        // Arrange
        var driver = new DriverAggregate(new DriverName("John Doe"), SickLeaveStatus.Active);
    ...
    public void Equals_WithSameId_ShouldReturnTrue()
    {
        // Arrange
        var id = Guid.NewGuid();
        var driver1 = new DriverAggregate(id, new DriverName("John Doe"));
        var driver2 = new DriverAggregate(id, new DriverName("Jane Smith")); // Different name, same ID
    ...
    public void Equals_WithDifferentId_ShouldReturnFalse()
    {
        ...
        var driver2 = new DriverAggregate(new DriverName("John Doe")); // Same name, different ID
    ...
    public void GetHashCode_WithSameId_ShouldBeSame()
    {
        ...
        var id = Guid.NewGuid();
        var driver1 = new DriverAggregate(id, new DriverName("John Doe"));
        var driver2 = new DriverAggregate(id, new DriverName("Jane Smith"));
    ...
    public void RequirementValidation_SickDriverCannotBeScheduled()
    {
        ...
        // Arrange
        var activeDriver = new DriverAggregate(new DriverName("Active Driver"));
