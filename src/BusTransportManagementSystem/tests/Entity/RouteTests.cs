...
{
    [Fact]
    public void Constructor_WithValidParameters_ShouldCreateRouteAggregate()
    {
        // Arrange
        var id = Guid.NewGuid();
        ...
        // Act
        var route = new RouteAggregate(id, routeNumber);
    ...
    public void Constructor_WithEmptyId_ShouldThrowArgumentException()
    {
        ...
        // Act & Assert
        Assert.Throws<ArgumentException>(() => new RouteAggregate(emptyId, routeNumber));
    }
    ...
    public void Constructor_WithNullRouteNumber_ShouldThrowArgumentNullException()
    {
        ...
        // Act & Assert
        Assert.Throws<ArgumentNullException>(() => new RouteAggregate(id, nullRouteNumber));
    }
    ...
    public void Equals_WithSameId_ShouldReturnTrue()
    {
        // Arrange
        var id = Guid.NewGuid();
        var route1 = new RouteAggregate(id, new RouteNumber("123"));
        var route2 = new RouteAggregate(id, new RouteNumber("456")); // Different route number, same ID
    ...
    public void Equals_WithDifferentId_ShouldReturnFalse()
    {
        ...
        var route2 = new RouteAggregate(new RouteNumber("123")); // Same route number, different ID
    ...
    public void GetHashCode_WithSameId_ShouldBeSame()
    {
        ...
        var id = Guid.NewGuid();
        var route1 = new RouteAggregate(id, new RouteNumber("123"));
        var route2 = new RouteAggregate(id, new RouteNumber("456"));
    ...
    public void RequirementValidation_RouteNumberRange()
    {
        ...
        // Arrange & Act
        var minRoute = new RouteAggregate(new RouteNumber("1"));
        var maxRoute = new RouteAggregate(new RouteNumber("9999"));
