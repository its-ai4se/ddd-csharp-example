...
{
    [Fact]
    public void Constructor_WithValidParameters_ShouldCreateBusAggregate()
    {
        // Arrange
        var id = Guid.NewGuid();
        ...
        // Act
        var bus = new BusAggregate(id, licensePlate, repairStatus);
    ...
    public void Constructor_WithoutRepairStatus_ShouldDefaultToOperational()
    {
        ...
        // Act
        var bus = new BusAggregate(id, licensePlate);
    ...
    public void Constructor_WithLicensePlateOnly_ShouldGenerateIdAndDefaultToOperational()
    {
        ...
        // Act
        var bus = new BusAggregate(licensePlate);
    ...
    public void Constructor_WithEmptyId_ShouldThrowArgumentException()
    {
        ...
        // Act & Assert
        Assert.Throws<ArgumentException>(() => new BusAggregate(emptyId, licensePlate));
    }
    ...
    public void Constructor_WithNullLicensePlate_ShouldThrowArgumentNullException()
    {
        ...
        // Act & Assert
        Assert.Throws<ArgumentNullException>(() => new BusAggregate(id, nullLicensePlate));
    }
    ...
    {
        // Arrange
        var bus = new BusAggregate(new LicensePlate("ABC123"), RepairStatus.UnderRepair);
    ...
    {
        // Arrange
        var bus = new BusAggregate(new LicensePlate("ABC123"), RepairStatus.Operational);
    ...
    {
        // Arrange
        var bus = new BusAggregate(new LicensePlate("ABC123"), RepairStatus.OutOfService);
    ...
    {
        // Arrange
        var operationalBus = new BusAggregate(new LicensePlate("ABC123"), RepairStatus.Operational);
        var repairBus = new BusAggregate(new LicensePlate("DEF456"), RepairStatus.UnderRepair);
        var outOfServiceBus = new BusAggregate(new LicensePlate("GHI789"), RepairStatus.OutOfService);
    ...
    public void Equals_WithSameId_ShouldReturnTrue()
    {
        // Arrange
        var id = Guid.NewGuid();
        var bus1 = new BusAggregate(id, new LicensePlate("ABC123"));
        var bus2 = new BusAggregate(id, new LicensePlate("XYZ789")); // Different license plate, same ID
    ...
    public void Equals_WithDifferentId_ShouldReturnFalse()
    {
        ...
        var bus2 = new BusAggregate(new LicensePlate("ABC123")); // Same license plate, different ID
    ...
    public void GetHashCode_WithSameId_ShouldBeSame()
    {
        ...
        var id = Guid.NewGuid();
        var bus1 = new BusAggregate(id, new LicensePlate("ABC123"));
        var bus2 = new BusAggregate(id, new LicensePlate("XYZ789"));
    ...
    public void RequirementValidation_BusInRepairCannotBeAssigned()
    {
        ...
        var repairBus = new BusAggregate(new LicensePlate("REPAIR001"));
        var outOfServiceBus = new BusAggregate(new LicensePlate("OUT001"));
    ...
    public void RequirementValidation_LicensePlateLength()
    {
        ...
        // Arrange & Act
        var shortPlate = new BusAggregate(new LicensePlate("A"));
        var maxLengthPlate = new BusAggregate(new LicensePlate("1234567890")); // 10 characters
