...
public class ScheduleTests
{
    ...
    private readonly Bus _operationalBus;
    private readonly Bus _busUnderRepair;
    ...
    public ScheduleTests()
    {
        ...
        _operationalBus = new Bus(new LicensePlate("BUS001"));
        _busUnderRepair = new Bus(new LicensePlate("BUS002"));
        _busUnderRepair.SetUnderRepair();
        
        _availableDriver = new Driver(new DriverName("John Doe"));
        _sickDriver = new Driver(new DriverName("Jane Smith"));
    ...
    public void AssignDriverToShift_MultipleDriversToSameShift_ShouldAllowFlexibility()
    {
        ...
        var driver2 = new Driver(new DriverName("Bob Wilson"));
    ...
    public void GetBusAssignmentsForDate_ShouldReturnCorrectAssignments()
    {
        ...
        var bus2 = new Bus(new LicensePlate("BUS003"));
        var route2 = new Route(new RouteNumber("456"));
    ...
    public void GetDriverAssignmentsForRoute_ShouldReturnCorrectAssignments()
    {
        ...
        var driver3 = new Driver(new DriverName("Alice Johnson"));
    ...
    public void IsBusAssignedOnDate_ShouldReturnCorrectResult()
    {
        ...
        var otherBus = new Bus(new LicensePlate("OTHER"));
    ...
    public void IsDriverAssignedToShift_ShouldReturnCorrectResult()
    {
        ...
        var otherDriver = new Driver(new DriverName("Other Driver"));
    ...
    public void RequirementValidation_SeveralBusesPerRoutePerDay_ShouldBeSupported()
    {
        ...
        var bus3 = new Bus(new LicensePlate("BUS003"));
    ...
    public void RequirementValidation_ThreeShiftsPerRoute_ShouldBeSupported()
    {
        ...
        var driver1 = new Driver(new DriverName("Morning Driver"));
        var driver2 = new Driver(new DriverName("Afternoon Driver"));
        var driver3 = new Driver(new DriverName("Night Driver"));
